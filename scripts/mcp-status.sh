...
# --- Ops Stack ---
echo -e "${CYAN}=== Ops Stack (10 containers + init) ===${NC}"
...
check_container "#11 zammad-scheduler" "mcp-zammad-scheduler"
check_container "    zammad-memcached" "mcp-zammad-memcached"
check_container "#12 elasticsearch"    "mcp-elasticsearch"
check_container "    bookstack-db"     "mcp-bookstack-db"
...
# --- Remote Stack ---
echo -e "${CYAN}=== Remote Stack (3 containers + 2 init) ===${NC}"
check_container "    guacamole-init"   "mcp-guacamole-init"
check_container "    guacamole-schema" "mcp-guacamole-schema"
